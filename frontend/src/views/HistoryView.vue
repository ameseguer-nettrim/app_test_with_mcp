  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div class="mb-6">
        ...
        <p class="text-gray-600 mt-1">View your computed and archived expenses</p>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div class="lg:col-span-3">
          <div class="card">
            <h2 class="text-lg font-semibold text-gray-800 mb-4">Computed Expenses</h2>
            ...
            <div v-else-if="computedExpenses.length === 0" class="text-center py-8">
              <p class="text-gray-500">No computed expenses yet.</p>
            </div>
            ...
            <div v-else class="space-y-4">
              ...
              >
                <div class="flex items-center justify-between mb-4 pb-2 border-b border-gray-200">
                  <h3 class="text-md font-semibold text-gray-700">Computed on {{ formatComputedDate(date) }}</h3>
                  <span class="text-sm text-gray-600">{{ group.length }} expense(s)</span>
                </div>
                    ...
                    <div class="flex justify-between items-start">
                      <div class="flex-1">
                        ...
                        <div class="flex items-center space-x-4 mt-2 text-sm text-gray-600">
                          ...
                          <span>•</span>
                          <span>Computed by: <span class="font-medium">{{ expense.computed_by_name }}</span></span>
                        </div>
                      </div>
                    </div>
                  </div>
